...
public class q {
    ...
    @FXML
    void BackB(ActionEvent event) {showSecondScene("helo-view.fxml", "Marathon Skills 2016");
    }


    @FXML
    void Cancel(ActionEvent event) {showSecondScene("helo-view.fxml", "Marathon Skills 2016 - Register as a runner");
    }

    @FXML
    void reg(ActionEvent event) {showSecondScene("f.fxml", "Marathon Skills 2016 - Register as a runner");
